...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal static let hyperBall = ImageAsset(name: "hyper_ball")
    ...
    internal static let fushigibanaBack = ImageAsset(name: "fushigibana_back")
    internal static let fushigidane = ImageAsset(name: "fushigidane")
    internal static let fushigidaneBack = ImageAsset(name: "fushigidane_back")
    internal static let fushigiso = ImageAsset(name: "fushigiso")
    internal static let fushigisoBack = ImageAsset(name: "fushigiso_back")
    internal static let hitokage = ImageAsset(name: "hitokage")
    internal static let hitokageBack = ImageAsset(name: "hitokage_back")
    internal static let kameru = ImageAsset(name: "kameru")
    internal static let kameruBack = ImageAsset(name: "kameru_back")
    internal static let kamex = ImageAsset(name: "kamex")
    internal static let kamexBack = ImageAsset(name: "kamex_back")
    internal static let okid = ImageAsset(name: "okid")
    internal static let rizard = ImageAsset(name: "rizard")
    internal static let rizardoBack = ImageAsset(name: "rizardo_back")
    internal static let rizardon = ImageAsset(name: "rizardon")
    internal static let rizardonBack = ImageAsset(name: "rizardon_back")
    ...
    internal static let zenigameBack = ImageAsset(name: "zenigame_back")
  }
}
